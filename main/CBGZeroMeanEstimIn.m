classdef CBGZeroMeanEstimIn < EstimIn
    % CBGZeroMeanEstimIn:  Implements zero mean Bernoulli-Gaussian input
    % estimator.
    % Note that this can also be achieved by combining CAwgnEstimIn with
    ...
    methods
        % Constructor
        function obj = CBGZeroMeanEstimIn(var0,p1, maxSumVal)
            obj = obj@EstimIn;
