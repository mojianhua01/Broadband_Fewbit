...
%% ADC setup
bit_vector = 1; %[1 2 3 4 +inf]; % [1, 2, 3, 4, 5, 6, 7, 8, +inf]; %[1 2 3 4 5 6 7 8 +inf];
...
%% Pilot block length
Np_vector = 2048; %512*(2:1:10); %[251 509 1021 1531 2039 2557 3067 3583 4093];

%% Training length
Nc = 512*20;

%% SNR
SNRdB_vector = 10; %linspace(-10, 40, 6); %linspace(-10, 40, 11);
...
Setup = struct('Nc',Nc, 'N_sc', N_sc, 'bit_vector',bit_vector,...
    'Np_vector',Np_vector, 'SNRdB_vector', SNRdB_vector,...
    'Num_chan',Num_chan);

% save results_Golay_Np_2048_08232016.mat bit_vector Nc Np_vector NMSE_BG_dB NMSE_GM_dB NMSE_BPDN_dB NMSE_LMMSE_dB NMSE_LS_dB...
%     NMSE_QIST_dB NMSE_QIHT_dB Num_chan SNRdB_vector Rate_pcsi_mean Rate_BG_mean Rate_GM_mean Rate_BPDN_mean...
%     Rate_LS_mean Rate_LMMSE_mean Rate_QIST_mean Rate_QIHT_mean MI_pcsi_mean MI_BG_mean MI_GM_mean MI_BPDN_mean...
%     MI_LS_mean MI_LMMSE_mean MI_QIST_mean MI_QIHT_mean;

% save results_VAMP_Chu_Np_2048_01012017.mat bit_vector Nc Np_vector NMSE_VAMP_dB Num_chan SNRdB_vector Rate_VAMP_mean  MI_VAMP_mean;
% save results_VAMP_Chu_10db_Np_2048_bit_1_inf_01012017.mat bit_vector Nc Np_vector NMSE_VAMP_dB Num_chan SNRdB_vector Rate_VAMP_mean  MI_VAMP_mean;
% save results_VAMP_Chu_0dB_Np_1024_5120_01012017.mat bit_vector Nc Np_vector NMSE_VAMP_dB Num_chan SNRdB_vector Rate_VAMP_mean  MI_VAMP_mean;

% save results_VAMP_Chu_Np_2048_01172017.mat bit_vector Nc Np_vector NMSE_VAMP_dB Num_chan SNRdB_vector;

% save results_GAMP_Chu_10dB_Np_1024_5120_01022017.mat bit_vector Nc Np_vector NMSE_BG_dB NMSE_GM_dB Num_chan SNRdB_vector Rate_BG_mean ...
%     Rate_GM_mean  MI_BG_mean MI_GM_mean;

% save results_Chu_10db_Np_1024_5120_09232016.mat bit_vector Nc Np_vector NMSE_BG_dB NMSE_GM_dB NMSE_BPDN_dB NMSE_LMMSE_dB NMSE_LS_dB...
%     NMSE_QIHT_dB Num_chan SNRdB_vector Rate_pcsi_mean Rate_BG_mean Rate_GM_mean Rate_BPDN_mean...
%     Rate_LS_mean Rate_LMMSE_mean Rate_QIHT_mean MI_pcsi_mean MI_BG_mean MI_GM_mean MI_BPDN_mean...
%     MI_LS_mean MI_LMMSE_mean MI_QIHT_mean;

% save results_Chu_10dB_Np_2048_bit_1_inf_08232016.mat bit_vector Nc Np_vector NMSE_BG_dB NMSE_GM_dB NMSE_BPDN_dB NMSE_LMMSE_dB NMSE_LS_dB...
%     NMSE_QIST_dB NMSE_QIHT_dB Num_chan SNRdB_vector Rate_pcsi_mean Rate_BG_mean Rate_GM_mean Rate_BPDN_mean...
%     Rate_LS_mean Rate_LMMSE_mean Rate_QIST_mean Rate_QIHT_mean MI_pcsi_mean MI_BG_mean MI_GM_mean MI_BPDN_mean...
%     MI_LS_mean MI_LMMSE_mean MI_QIST_mean MI_QIHT_mean;
